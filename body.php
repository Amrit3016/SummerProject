  ...
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
      ...
      <div class="item">
        <img src="img/banner4.jpg" alt="Dhangadhi, kailali" style="width:100%;">
        
      </div>
      <div class="item">
        <img src="img/banner1.jpg" alt="Dhangadhi, kailali" style="width:100%;">
        
      </div>
      <div class="item">
        <img src="img/banner3.jpg" alt="Dhangadhi, kailali" style="width:100%;">
							...
							<div id="get_product_home2">
								...
								<div class="product-widget">
									...
									<div class="product-body">
										...
										<h4 class="product-price">1150.00 <del class="product-old-price">1190.00</del></h4>
									</div>
								</div>
								<!-- /product widget -->
								...
								<div class="product-widget">
									...
									<div class="product-body">
										<p class="product-category">Category</p>
										<h3 class="product-name"><a href="#">product name goes here</a></h3>
										<h4 class="product-price">1000.00 <del class="product-old-price">1300.00</del></h4>
									</div>
								</div>
								<!-- /product widget -->
								...
								<div class="product-widget">
									...
									<div class="product-body">
										<p class="product-category">Category</p>
										<h3 class="product-name"><a href="#">product name goes here</a></h3>
										<h4 class="product-price">Rs980.00 <del class="product-old-price">Rs1090.00</del></h4>
									</div>
								</div>
								<!-- product widget -->
							</div>
							...
							<div>
								...
								<div class="product-widget">
									...
									<div class="product-body">
										<p class="product-category">Category</p>
										<h3 class="product-name"><a href="#">product name goes here</a></h3>
										<h4 class="product-price">Rs980.00 <del class="product-old-price">Rs1000.00</del></h4>
									</div>
								</div>
								<!-- /product widget -->
								...
								<div class="product-widget">
									...
									<div class="product-body">
										<p class="product-category">Category</p>
										<h3 class="product-name"><a href="#">product name goes here</a></h3>
										<h4 class="product-price">Rs1000.00 <del class="product-old-price">Rs1100.00</del></h4>
									</div>
								</div>
								<!-- product widget -->
							</div>
							...
							<div>
								...
								<div class="product-widget">
									...
									<div class="product-body">
										<p class="product-category">Category</p>
										<h3 class="product-name"><a href="#">product name goes here</a></h3>
										<h4 class="product-price">RS860.00 <del class="product-old-price">RS990.00</del></h4>
									</div>
								</div>
								<!-- /product widget -->
							...
							<div>
								...
								<div class="product-widget">
									...
									<div class="product-body">
										<p class="product-category">Category</p>
										<h3 class="product-name"><a href="#">product name goes here</a></h3>
										<h4 class="product-price">Rs880.00 <del class="product-old-price">Rs980.00</del></h4>
									</div>
								</div>
								<!-- /product widget -->
